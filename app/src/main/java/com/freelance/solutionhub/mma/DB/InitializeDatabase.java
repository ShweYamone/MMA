...
@Database(entities = {ServiceInfoModel.class, UpdateEventBody.class, Event.class, UploadPhotoModel.class, FaultMappingJSONString.class} , version = 1,exportSchema = false)
